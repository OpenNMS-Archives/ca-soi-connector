...
public class OpennmsConnectorConfig {
    ...
    OpennmsConnectorConfig(Map<String, String> params) {
        this.streamProperties = params.getOrDefault("stream-properties", "stream.properties");
        this.alarmTopic = params.getOrDefault("alarm-topic", "alarms");
        this.nodeTopic = params.getOrDefault("node-topic", "nodes");
    }
